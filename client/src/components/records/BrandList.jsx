...
import { RegisterDelete, RegisterUpdate} from '../forms';
...
export const BrandList = () => {
    ...
    return (
        <>
            {showUpdated && (
                <RegisterUpdate id={selectId} onClick={handleCloseModal} />
            )}
            {showDeleted && (
                <RegisterDelete id={selectId} onClick={handleCloseModal} />
            )}
                                    ...
                                    >
                                        ...
                                        <td className='px-4 py-2 border border-gray-300 text-center'>
                                            <button
                                                ...
                                                title='Editar'
                                                onClick={() => handleShowUpdate(marca.id)}
                                            >
                                                <FaEdit size={18} />
                                            </button>
                                            {filterActive && (
